#include "kato/opencv_addons.h"
#include "kato/function.h"
// --------------------------------------------------------------------------------------------------------------------

// --------------------------------------------------------------------------------------------------------------------
const cv::Mat kato::function::cvMean(const std::vector<cv::Mat> &_mats)
{
...
// --------------------------------------------------------------------------------------------------------------------
const cv::Mat kato::function::cvFuseExposures(const std::vector<cv::Mat> &_exposures, const std::vector<uint> &_expTimes, const float _maxVal, const float threshold)
{
...
// --------------------------------------------------------------------------------------------------------------------
void kato::function::cvCopy(const std::vector<cv::Mat> &source, std::vector<cv::Mat> &destination)
{
    destination.clear();
...
// --------------------------------------------------------------------------------------------------------------------
const std::string kato::function::cvTypeToString(const int _cvType)
{
    if (_cvType == CV_8UC1)
        return "CV_8UC1";
...
// --------------------------------------------------------------------------------------------------------------------
const float kato::function::cvTypeMax(const int _cvType)
{
    if (_cvType == CV_8UC1)
        return 255.0;
    else if (_cvType == CV_16UC1)
...
// --------------------------------------------------------------------------------------------------------------------
const int kato::function::cvTypeToSize(const int _cvType)
{
    if (_cvType == CV_8UC1)
        return 8;
    else if (_cvType == CV_16UC1)
...
// --------------------------------------------------------------------------------------------------------------------
const std::string kato::function::cvInfo(const cv::Mat &_mat)
{
...
// --------------------------------------------------------------------------------------------------------------------
const std::string kato::function::cvInfo(const std::vector<cv::Mat> &_mats)
{
    std::stringstream out;
...
// --------------------------------------------------------------------------------------------------------------------
const std::string kato::function::cvInfo(const std::vector<std::vector<cv::Mat>> &_mats)
{
    std::stringstream out;
...
// --------------------------------------------------------------------------------------------------------------------
void kato::function::calcHistogram(const cv::Mat &_image, const cv::Mat &_mask, std::vector<uint> &_hist, const int _nBins, const float *&_range, const bool uniform, const bool accumulate)
{
    cv::Mat hist;
...
// --------------------------------------------------------------------------------------------------------------------
cv::Ptr<cv::freetype::FreeType2> kato::function::cvCustomFont(std::string ttf)
{
...
// --------------------------------------------------------------------------------------------------------------------
void kato::function::cvPutText(cv::Mat &_image, std::string _text, cv::Point _origin, double _scale, const cv::Scalar &color, cv::Ptr<cv::freetype::FreeType2> font)
{
    if (font.empty())
...
// --------------------------------------------------------------------------------------------------------------------
void kato::function::cvDistanceCircle(cv::Mat &_image, cv::Point _center, float _radius, const cv::Scalar &color)
{
