#include "kato/CCfits_opencv_addons.h"
// --------------------------------------------------------------------------------------------------------------------

// --------------------------------------------------------------------------------------------------------------------
const int kato::function::cvTypeToCCfitsBitPix(const int _cvType)
{
    if (_cvType == CV_8UC1)
        return BYTE_IMG;
...
// --------------------------------------------------------------------------------------------------------------------
const int kato::function::CCfitsBitPixTocvType(const int _bitPix)
{
    if (_bitPix == BYTE_IMG)
        return CV_8UC1;
